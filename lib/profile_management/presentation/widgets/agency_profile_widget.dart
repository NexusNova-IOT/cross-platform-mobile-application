...
class AgencyProfileWidget extends StatelessWidget {
  final AgencyProfile userProfile;
  final TextEditingController _legalNameController;
  final TextEditingController _phoneController;
  final TextEditingController _emailController;

  AgencyProfileWidget({super.key, required this.userProfile})
      : _legalNameController =
            TextEditingController(text: userProfile.legalName),
          ...
          Container(
            ...
            child: Column(
              children: [
                CircleAvatar(
                  radius: 70,
                  backgroundImage: NetworkImage(userProfile.agencyPhotoUrl),
                ),
